...
export default function DeeceeHair(): React.ReactElement {
  ...
  const addToCart = () => {
    if (selectedProduct && selectedColor && selectedSize) {
      ...
      if (existingItem) {
        ...
        setCart([
          ...cart,
          { product: selectedProduct, color: selectedColor, size: selectedSize, quantity: 1 },
        ]);
      }
      alert("Added to cart!");
    } else {
  ...
  const PromoSlider = () => {
    // Create a long, repeating track for seamless looping
    const trackMessages = useMemo(() => {
      const loops = 4; // repeat 4x to ensure continuous fill on wide screens
      const arr: string[] = [];
      for (let i = 0; i < loops; i++) {
        arr.push(...promoMessages);
      }
      return arr;
    }, []);
    ...
    return (
      <div className="bg-rose-600 py-2 overflow-hidden relative">
        <div className="w-full overflow-hidden">
          <div className="marquee flex items-center">{/* Styled via styled-jsx below */}
            {trackMessages.map((msg, idx) => (
              <span key={idx} className="text-sm font-medium text-white mx-8">
                {msg}
              </span>
            ))}
          </div>
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="hidden lg:block p-2 text-gray-700 hover:text-rose-600 transition"
            >
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button
              onClick={() => setCurrentPage("appointment")}
              className="bg-transparent border-2 border-white text-white px-8 py-4 rounded-full font-semibold hover:bg-white hover:text-rose-600 transition transform hover:scale-105 flex items-center justify-center gap-2"
            >
          ...
          {filtered.map((product) => (
            ...
            >
              ...
              {product.isBestseller && (
                <span className="inline-block mt-2 px-2 py-1 text-xs font-semibold bg-rose-100 text-rose-700 rounded-full">
                  Bestseller
                </span>
              )}
              {product.isNew && (
                <span className="inline-block mt-2 ml-2 px-2 py-1 text-xs font-semibold bg-green-100 text-green-700 rounded-full">
                  New
                </span>
              )}
            </div>
  ...
  const ProductPage = () => {
    ...
    return (
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <button onClick={() => setCurrentPage("shop")} className="mb-6 text-rose-600 hover:underline">
          ← Back to Shop
        </button>
          ...
          <div className="lg:col-span-1 bg-white rounded-xl border border-gray-200 p-6">
            ...
            <div className="space-y-4 text-sm">
              ...
              <div className="flex items-start gap-3 text-gray-700">
                ...
                <div>
                  123 Luxe Avenue, Andheri West
                  <div className="text-gray-500">Mumbai, Maharashtra</div>
                </div>
              </div>
  ...
  const AppointmentPage = () => {
    ...
    // Determine blocked slots deterministically by date+location
        ...
        {confirmed ? (
          <div className="bg-white border border-gray-200 rounded-xl p-6">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3">
              <button onClick={resetForm} className="bg-rose-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-rose-700 transition">
                Book Another Appointment
              </button>
              <button onClick={() => setCurrentPage("home")} className="px-6 py-3 rounded-lg font-semibold border border-gray-300 text-gray-700 hover:bg-gray-100 transition">
                Back to Home
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                ...
                <li>
                  <button onClick={() => setCurrentPage("shop")} className="hover:text-white transition">Shop</button>
                </li>
                <li>
